...
local namespace_id = vim.api.nvim_create_namespace("ChatOllamaCC")
...
M.complete = function()
  ...
  Api.completions({
    ...
    for i = 0, #lines - 1, 1 do
      vim.api.nvim_buf_add_highlight(buffer, namespace_id, "ChatOllamaCompletion", start_row + i, 0, -1)
      vim.api.nvim_buf_add_highlight(popup.bufnr, namespace_id, "ChatOllamaCompletion", i, 0, -1)
    end
